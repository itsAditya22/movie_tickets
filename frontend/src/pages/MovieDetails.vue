<template>
  <div v-if="!movieResource.loading && movieResource.doc">
    ...
    <center><h2 class="font-medium text-xl mt-7 text-gray-900">How many seats?</h2></center>

    <div class="flex justify-center flex-wrap w-full space-x-4 mt-6">
        <button 
            v-for="index in 8" 
            :key="index" 
            @click="setNumberOfSeats(index)" 
            class="inline-block w-20 h-20 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg shadow-lg transition duration-300 focus:outline-none focus:ring focus:ring-blue-800"
        >
            {{ index }}
        </button>
    </div>
      ...
      <div v-else-if="currentStep === 2">
        <div class="flex justify-center flex-wrap w-full space-y-4">
          <center>
      ...
      <div v-else-if="currentStep === 3">
        <center><h2 class="font-medium text-xl mt-7 text-gray-900">Select Seats</h2></center>
